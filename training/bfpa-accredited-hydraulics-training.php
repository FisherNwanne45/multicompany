...
<main>
	...
	<div class="block">
		...
		<section class=" mb-16">
			<div class="container xl:max-w-screen-xl">
				<h2 class="subheading">
					Developing competence and reducing risk with hydraulics training courses
				</h2>
			</div>
		</section>
				...
				<div class="container xl:max-w-screen-xl">
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0" src="../images/content-images/square/_square/bfpa.jpg"
								alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<h2 class="heading mb-0">H1 hydraulic competence assessment</h2>
							<div class="typo">
								<p><strong>Location: Aberdeen</strong></p>
								<p><strong>Duration: 2 days</strong></p>
								<p>This course is intended for anyone with a technical background who works on machines
									incorporating hydraulic systems. This is the first level of competency assessment,
									allowing progression to more advanced levels of courses.</p>
								<p>It assesses the practical skills and theoretical knowledge of the attendee to the H1
									level, as determined by the specifications laid out by BFPA.</p>
								<p>Candidates who successfully pass both the practical and theory elements of the
									assessment will receive a BFPA H1 certificate.</p>
							</div>
				...
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							...
							<p>Suitable for anyone involved in the maintenance and operation of fluid power systems,
								this course covers basic hydraulics principles, hydraulic symbols and notation, basic
								electrical theory, and health and safety.</p>
						</div>
					</div>
				...
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							...
							<p>This course is suitable for personnel with a level 1 qualification who are plant
								managers, engineers, technicians, or craftsmen involved in the maintenance and
								management of fluid power systems.</p>
							<p>Key areas covered in this training course include pumps and associates control systems,
								causes of pump failures, valve sizing and performance, proportional control, and
								hydraulic motor performance.</p>
						</div>
					</div>
					<div class="mx-auto lg:max-w-screen-lg">
						<a href="../booking.php" class="button button--alt m-2">
				...
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p><strong>Location – Aberdeen</strong></p>
							<p><strong>Duration – 4 days</strong></p>
							<p>This course is designed for mechanical and electrical technicians and fitters involved in
								the installation, commissioning, maintenance, and fault finding of hydraulic systems
								with proportional valves and their associated controls to increase the knowledge and
								practical skills involved in proportional hydraulic systems.</p>
							<p>Candidates should have attended the Level 1 Hydraulics course and have a good
								understanding of modern hydraulic systems before undertaking this course. Some knowledge
								of basic electrical circuits would be advantageous.</p>
						</div>
					</div>
					<div class="mx-auto lg:max-w-screen-lg">
						<a href="../booking.php" class="button button--alt m-2">
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="-fSUqylEv2Qa3n1Tz5u2NgHssQWmMn5BGghGBPNVQyh18-jwdZTB6rCSpZ1CPM9RSrxOJ5bh_FJ3i8tt3HwUdlF4MnG4FCVcO7yJyRrlsak=" />
				...
				<input type="hidden" name="fdchk-0b5dcff9-d7ea-4cb7-9038-821c8bd32a9e"
					value="fdchk-0b5dcff9-d7ea-4cb7-9038-821c8bd32a9e" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
