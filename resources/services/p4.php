...
<main>
	...
	<section class="banner banner--light-grey mb-16">
		<div class="container">
			...
			<form action="<?php echo $url; ?> /resources/services/p4" class="mb-16">
				<div class="-mx-4">
			...
			<div class="-mx-4">
				<ol class="flex flex-wrap">
					<li class="w-full px-4 mb-16 md:w-1/4">
						<div class="resources-block">
							<img class="latest-block__img"
								src="../../images/content-images/thumbnails/Sparrows-Group-overview_four-page_email-1.jpg"
								alt="">
							<span class="resources-block__tag">Services</span>
							<h3 class="equipment-block__title"><?php echo $name; ?> overview</h3>
							<span class="resources-block__tag">Download PDF options:</span>
							<div class="flex">
								<a class="button button--alt mr-4"
									href="../../files/services/Sparrows-Group-overview.pdf" target="_blank">
									English
								</a>
							</div>
						</div>
					...
					<li class="w-full px-4 mb-16 md:w-1/4">
						<div class="resources-block">
							<img class="latest-block__img"
								src="../../images/content-images/thumbnails/Sparrows-Group-overview-Saudi.jpg" alt="">
							<span class="resources-block__tag">Services</span>
							<h3 class="equipment-block__title"><?php echo $name; ?> Overview – Saudi</h3>
							<span class="resources-block__tag">Download PDF options:</span>
							<div class="flex">
								<a class="button button--alt mr-4"
									href="../../files/services/SaudiArabia_Overview_4pp_A4.pdf" target="_blank">
									English
								</a>
							</div>
						</div>
					...
					<li class="w-full px-4 mb-16 md:w-1/4">
						<div class="resources-block">
							<img class="latest-block__img"
								src="../../images/content-images/thumbnails/Well-Services_four-page_A4-1.png" alt="">
							<span class="resources-block__tag">Services</span>
							<h3 class="equipment-block__title">Well Services</h3>
							<span class="resources-block__tag">Download PDF options:</span>
							<div class="flex">
								<a class="button button--alt mr-4"
									href="../../files/services/Well-Services_four-page_A4.pdf" target="_blank">
									English
								</a>
							</div>
						</div>
					...
					<li class="w-full px-4 mb-16 md:w-1/4">
						<div class="resources-block">
							<img class="latest-block__img"
								src="../../images/content-images/thumbnails/Wire-rope-and-inspection-spooling-system-WRISS_print-ready-1.jpg"
								alt="">
							<span class="resources-block__tag">Services</span>
							<h3 class="equipment-block__title">Wire Rope Inspection and Spooling System (WRISS)</h3>
							<span class="resources-block__tag">Download PDF options:</span>
							<div class="flex">
								<a class="button button--alt mr-4"
									href="../../files/services/Wire-rope-and-inspection-spooling-system-WRISS_print-ready.pdf"
									target="_blank">
									English
								</a>
							</div>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="4Ab_O7XXLKxqmot6Xu2YZLvZI6SI3X_uBsXDtyWp18aUoZsem9-iq6lgzg3er1yZOvi4DgeX0gDNvlnM8pMV2U21t8Ju6LGy2u76J_Su0ug=" />
				...
				<input type="hidden" name="fdchk-6ab02520-3aba-4076-9bb5-a0008285b677"
					value="fdchk-6ab02520-3aba-4076-9bb5-a0008285b677" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
