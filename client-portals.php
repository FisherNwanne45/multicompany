					...
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0"
								src="images/content-images/square/_square/Connect-database-sparrows-group.jpg" alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<h2 class="heading mb-0">Connect database</h2>
							<div class="typo">
								<p>Connect provides 24/7 online access to all your inspection records.</p>
							</div>
			...
			<div class="container xl:max-w-screen-xl">
				<div class="flex flex-wrap">
					<div class="w-full md:w-2/5 md:flex md:items-center  md:pl-8 md:order-2 ">
						<img class="w-full mb-8 md:mb-0"
							src="images/content-images/square/_square/crane-condition-database.jpg" alt="">
					</div>
					<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pr-8 md:order-1 ">
						<h2 class="heading mb-0">Crane condition database</h2>
						<div class="typo">
							<p>Our database is currently under construction. </p>
							<p>Please contact a <?php echo $name; ?> representative in your region with your query.</p>
						</div>
						<div class="flex flex-wrap items-start -mx-2">
							<a href="contact.php" class="button button--alt m-2">
								Contact us
							</a>
						</div>
					</div>
