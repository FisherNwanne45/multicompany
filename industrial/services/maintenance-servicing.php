...
<main>
	...
	<section class="page-banner  page-banner--with-image bgLazy"
		...
		data-src="../../images/content-images/banners/_bannerImage/maintenance-servicing.jpg">
			...
			<div class="flex flex-wrap justify-between md:flex-nowrap">
				<div class="page-banner__overlay ">
					...
					<h2 class="page-banner__subtitle">
						Maintenance and servicing to ensure the reliability of machinery and equipment across the
						industrial sector.
					</h2>
					<div class="mt-8">
					</div>
		...
		<section class="mt-16 mb-16">
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					<h2 class="heading">
						We deliver predictive and time based maintenance and servicing activities for a variety of
						mechanical, hydraulic and electrical machinery / equipment for customers across the industrial
						sector.
					</h2>
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p>The equipment types we maintain cover everything from small loose lifting equipment to
								hydraulic systems and overhead/gantry cranes. </p>
							<p>All the industries we work with, whether it’s manufacturing, processing or construction,
								require confidence in the integrity of their operations. Predictive maintenance is
								becoming the preferred solution for the majority of our customers who want to ensure
								maximum equipment availability while improving reliability and safety. </p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../images/content-images/square/_square/Sparrows_61.jpg" alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<div class="typo">
								<p>To ensure safety and reliability while optimising uptime and minimising costs we work
									with customers to develop and deliver predictive maintenance routines. In contrast
									to generic time-based maintenance strategies, a predictive regime takes elements
									such as equipment usage rate; availability for maintenance windows; access issues;
									and personnel skill levels into consideration. </p>
								<p>Our process for the development of inspection and maintenance strategies is an
									ongoing holistic process but generally follows the steps below. </p>
								<ul>
									<li>FMECA studies of machinery/equipment carried out</li>
									<li>Equipment criticality review undertaken </li>
									<li>Planned maintenance strategy created (taking any customer-specific strategies
										into consideration)</li>
									<li>Spare parts assessments concluded.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container xl:max-w-screen-xl">
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pl-8 md:order-2 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../images/content-images/banners/_square/Sparrows-Group-inspector.jpg" alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pr-8 md:order-1 ">
							<div class="typo">
								<p>With over 45 years of experience maintaining safety critical equipment, we also have
									the knowledge and skills to develop condition monitoring systems which further
									optimise reliability and safety while reducing costs. Our condition monitoring
									system is designed to monitor:</p>
								<ul>
									<li>Structural components</li>
									<li>Hydraulic components</li>
									<li>Mechanical mechanisms</li>
									<li>Winch ropes.</li>
								</ul>
								<p>This truly predictive approach delivers cost benefits through:</p>
								<ul>
									<li>Reduction of unplanned breakdowns</li>
									<li>Reduced maintenance down time through planning and enhanced diagnostics</li>
									<li>Streamlined manpower requirement as a result of planning improvements</li>
									<li>Optimised stock and inventory management.</li>
								</ul>
								<p>We fully mange all of our maintenance regimes, from carrying out inspection to
									delivering any required refurbishments and repairs. </p>
								<p>Many of our mechanical, hydraulic and electrical technicians and riggers are fully
									trained and certified in rope access to increase the speed and simplicity of
									inspecting and maintaining equipment at height. </p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="nrdz1Ci3XWatpqxASvJnWboUqtzCi4eWQMYjvxtqoLkFHKVjEUZ5fNfRQuJDzy1T_cSfNBOILT3Mc9C0uMXtoQu2V8pQK8bNS1PEWn43CT8=" />
				...
				<input type="hidden" name="fdchk-98ec0084-9ce9-4330-a744-764b334a188f"
					value="fdchk-98ec0084-9ce9-4330-a744-764b334a188f" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
