...
<main>
    ...
    <section class="page-banner  page-banner--with-image bgLazy"
        ...
        data-src="../../images/content-images/banners/_bannerImage/industrial-repair.jpg">
            ...
            <div class="flex flex-wrap justify-between md:flex-nowrap">
                <div class="page-banner__overlay ">
                    ...
                    <h2 class="page-banner__subtitle">
                        Refurbishment, upgrade and repair services to improve reliability and extend the life of safety
                        critical equipment in the industrial sector.
                    </h2>
                    <div class="mt-8">
                    </div>
                </div>
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
                            <img class="w-full mb-8 md:mb-0"
                                src="../../images/content-images/square/_square/industrial-repairs.jpg" alt="">
                        </div>
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
                            <h2 class="heading mb-0">Repair</h2>
                            <div class="typo">
                                <p>Our team of specialist technicians are experienced at fixing breakdowns. When a
                                    breakdown occurs, our focus is on getting equipment up and running again safely and
                                    as soon as possible. </p>
                                <p>We have mechanical, electrical and hydraulic technicians located across the world and
                                    they can be quickly mobilised to any location to undertake repairs on-site. Backed
                                    by a global network of engineers, we can conduct root cause analysis and repair
                                    complex technical issues.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container xl:max-w-screen-xl">
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-2/5 md:flex md:items-center  md:pl-8 md:order-2 ">
                            <img class="w-full mb-8 md:mb-0"
                                src="../../images/content-images/square/_square/industrial-refurb.jpg" alt="">
                        </div>
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pr-8 md:order-1 ">
                            <h2 class="heading mb-0">Refurbishment</h2>
                            <div class="typo">
                                <p>Ageing equipment can be partly or fully refurbished to extend its life span and
                                    improve operational integrity. </p>
                                <p>We support customers in analysing what requires refurbishment to achieve their
                                    operational objectives. Minor scopes can often be completed in-situ to minimise the
                                    impact on operations and larger scopes, such as a full winch or gantry/overhead
                                    crane refurbishments, can be undertaken at our local workshop facilities. We have
                                    workshop facilities at strategic bases all over the globe, ready to support clients
                                    regardless of location. </p>
                                <p>Our trained technicians are skilled in the complete refurbishment and repair of
                                    components and can advise on whether it would be more effective to upgrade relevant
                                    parts.</p>
                                <p>As part of the refurbishment process we carry out:</p>
                                <ul>
                                    <li>Equipment strip down, overhaul, assembly, and testing</li>
                                    <li>Machining services and reverse engineering of components</li>
                                    <li>Fabrication and painting</li>
                                    <li>Load testing</li>
                                </ul>
                                <p>During the refurbishment process, we ensure all equipment is stripped down of every
                                    component, which includes cleaning, blasting, and repainting before it is
                                    recertified. This guarantees each part is fully operational and is fit for purpose.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <div class="container xl:max-w-screen-xl">
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
                            <img class="w-full mb-8 md:mb-0"
                                src="../../images/content-images/square/_square/industria-upgrades.jpg" alt="">
                        </div>
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
                            <h2 class="heading mb-0">Upgrade</h2>
                            <div class="typo">
                                <p>Machinery and system upgrades address obsolescence issues while future-proofing and
                                    improving the performance of safety-critical equipment. </p>
                                <p>We upgrade a variety of size of control systems, from modular controllers to large
                                    interconnected systems such as Programmable Logic Controllers (PLCs) and Human
                                    Machine Interfaces (HMIs). </p>
                                <p>Machinery upgrades such as installing automated lubrication systems allow customers
                                    to improve the performance and reliability of any mechanical, drive train and
                                    rotating equipment. </p>
                                <p>As part of our delivery process, we work with customers to understand their
                                    requirements and ensure we specify and design a solution that will safely and
                                    reliably extend the life of their machinery. </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contact-form" id="contactForm">
            <form method="post" action="<?php echo $url; ?>/submit.php">
                ...
                <input type="hidden" name="CRAFT_CSRF_TOKEN"
                    value="T41RRFwk0epnLmWeqyVM6-ttVw8d3-2k6qZiuDK5OvuL8GCbJ6sZ7AbrYHI3XKHfN0xW6vJfBo-dCi1nZ5GHk6HWFs15-FyPxb8Bokjaaa8=" />
                ...
                <input type="hidden" name="fdchk-4ef567a8-1c37-43cf-a1b4-6ee05d7bb734"
                    value="fdchk-4ef567a8-1c37-43cf-a1b4-6ee05d7bb734" />
                <input type="hidden" name="formPayload"
                    value="" />
            </form>
