...
<main>
	...
	<section class="page-banner  page-banner--with-image bgLazy"
		...
		data-src="../../images/content-images/banners/_bannerImage/industrial.jpg">
			...
			<div class="flex flex-wrap justify-between md:flex-nowrap">
				<div class="page-banner__overlay ">
					...
					<h2 class="page-banner__subtitle">
						Delivering engineering, equipment inspection, maintenance, refurbishment and specialist
						mechanical handling services to owners and operators of plant and equipment OEMs.
					</h2>
					<div class="mt-8">
					</div>
				</div>
		...
		<section class="mt-16 mb-16">
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					<h2 class="heading">
						Working across a broad range of industries we support owners and operators of a variety of
						facilities including plants, factories, refineries, ports, power stations and mines, as well as
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p>We do this by utilising our multi-disciplined technical expertise to deliver a variety of
								engineering, inspection, maintenance, refurbishment and mechanical handling services.
							...
							<p>Our customer-focused service to delivery approach means we are available 24/7, ready to
								mobilise on short notice when required. We know that minimising downtime of
								machinery/equipment and operations is crucial, and our 45 years of experience working in
								the energy industry means everything we do is focused on optimising performance and
								safety.</p>
							<p>We thrive on being set challenges by our customers. Whether it’s a single piece of
								mechanical, hydraulic or electrical machinery that needs repaired/upgraded or a complex
				...
				<div class="container xl:max-w-screen-xl">
					<div class="flex flex-wrap">
						...
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							...
							<div class="typo">
								<p>With a comprehensive in-house engineering capability, we can offer a fully integrated
									service, from providing inspections and lift planning to carrying out machinery and
									equipment changeouts, installations and upgrades, and servicing and repairs. </p>
								<p>Our engineering teams are made up of specialists from various disciplines, allowing
									us to support our customers across the lifecycle of any industrial facility. </p>
								...
								<p>This complete capability means we can also provide reverse engineering solutions for
									old and obsolete machinery, safely extending the life of the equipment and reducing
				...
				<div class="-mx-4">
					<div class="flex flex-wrap md:flex-nowrap">
						...
						<div class="flex items-center w-full px-4 md:w-3/5">
							<form class="search" action="https://<?php echo $url; ?>/search/results">
