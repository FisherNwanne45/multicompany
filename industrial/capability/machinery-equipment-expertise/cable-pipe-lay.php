					...
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../../images/content-images/square/_square/Durocher-tensioner-2.jpg" alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<div class="typo">
								<p>Our Cable &amp; Pipe Lay Solutions (CPLS) support industrial customers to safely and
									efficiently carry out the deployment of products and end terminations. </p>
								<p>As a global supplier of both hydraulic and electrical cable and pipe lay equipment,
									our products are used for the handling of a wide variety of electric power
									transmission and telecommunications cables. Our expertise covers cables and pipe
									being laid in water of any depth. </p>
								<p><?php echo $name; ?> supply equipment (sale and rental) as well as deliver a range of engineering
									and support services to ensure projects are carried out efficiently with no damage
									to the product. We also carry out a range of maintenance and engineering services
									for equipment such as troubleshooting, refurbishments and upgrades.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container xl:max-w-screen-xl">
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pl-8 md:order-2 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../../images/content-images/square/_square/Lake-Michigan-tensioner-job-1.jpg"
								alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pr-8 md:order-1 ">
							<div class="typo">
								<p>The equipment our expertise covers and what we can supply includes:</p>
								<ul>
									<li>Tensioners</li>
									<li>Overboarding systems</li>
									<li>Carousels</li>
									<li>Loaders and baskets</li>
									<li>Under rollers</li>
									<li>Reel drive systems</li>
									<li>Level wind and dynamometers</li>
									<li>Installation and transport reels</li>
									<li>Pipe straighteners.</li>
								</ul>
								<p>Our tensioners are located across the world, allowing us to deploy equipment and
									technicians quickly and cost-effectively, however, we can also mobilise to any
									location to meet specific project demands. </p>
								<p>Visit our services pages to find out more about how we support customers at every
									stage of the equipment life cycle. </p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="nNT1gVqtHI0TKwtKRv_T-84wtIBaBE07yApgoiwqo64B-G0xpIokEtWyxLcx1Wy4Q0k4Ph-FmZ-4V87oIEonDIN6FNdna8XaT7cMCMv7VFE=" />
				...
				<input type="hidden" name="fdchk-28bcbfb2-a84d-4694-98b3-d44c43aa7918"
					value="fdchk-28bcbfb2-a84d-4694-98b3-d44c43aa7918" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
