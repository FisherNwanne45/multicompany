...
<main>
							...
							<div class="flex w-full md:w-1/3 px-4 mb-8">
								<figure class="gallery__item" itemprop="associatedMedia" itemscope
									...
									<a class="gallery__link galleryItem"
										href="../../../images/content-images/square/Bulk-terminal-shutdown.jpg"
										itemprop="contentUrl" data-height="3024" data-width="3024" data-pos="1"
										data-caption="">
	...
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
										...
										<img class="gallery__image"
											src="../../../images/content-images/square/_contentImage/Bulk-terminal-shutdown.jpg"
							...
							<div class="flex w-full md:w-1/3 px-4 mb-8">
								<figure class="gallery__item" itemprop="associatedMedia" itemscope
									itemtype="http://schema.org/ImageObject">
									<a class="gallery__link galleryItem"
										href="../../../images/content-images/case-studies/Bulk-terminal-shutdown-USA.jpg"
										itemprop="contentUrl" data-height="3024" data-width="3024" data-pos="2"
										data-caption="">
										<span class="circle-btn circle-btn--white">
											<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 36 36"
												xml:space="preserve">
	...
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
										...
										<img class="gallery__image"
											src="../../../images/content-images/case-studies/_contentImage/Bulk-terminal-shutdown-USA.jpg"
											alt="" itemprop="thumbnail">
									</a>
									<div class="flex items-center mt-5">
										<div class="gallery__info">
		...
		<section class="">
			<div class="container xl:max-w-screen-xl">
				<div class="typo">
					<p>At a coal plant in Braithwaite, Louisiana, <?php echo $name; ?> recently completed a range of gearbox
						alignments, repairs and routine maintenance tasks during the plant’s planned quarterly outage.
					</p>
					<p>Having previously conducted training in the plant for crane and forklift operators, the
						opportunity arose for <?php echo $name; ?> to assist the client further by carrying out the repairs and
						routine maintenance that keep an offloading facility such as this one running efficiently.</p>
					<p>With a planned shutdown of seven days, the <?php echo $name; ?> team (comprising six millwrights, two welders
						and two support staff) was tasked with completing various gearbox alignments, replacing bucket
						conveyors, scraper plates and conveyor belt tables, as well as undertaking general maintenance
						and safety repairs across the whole facility. </p>
					<p>With clear and effective communication between team members and comprehensive safety processes in
						place, the <?php echo $name; ?> team completed the maintenance work in just five days - two days ahead of
						the original schedule. And though sooner than expected, each team member kept safety as their
						number one priority throughout the shutdown. </p>
					<p>A contributing factor to the efficiency of <?php echo $name; ?> during this shutdown came from the team’s
						training using <a href="http://startechla.com/">Star-Tech</a>
						Laser Shaft Alignment products. Equipped with Advanced Alignment Training, the <?php echo $name; ?> team was
						able to conduct highly-accurate laser alignment using Star-Tech’s specialized equipment. </p>
					<p>A process that could traditionally take up to three hours using calipers can now take around 30
						minutes (depending on the degree of misalignment). As well as saving time and cost, the laser
						alignment procedure also delivers more accurate measurements leading to unprecedented precision.
					</p>
					<p>Gearbox alignments made up a significant part of our work scope in Braithwaite, which is an
						essential part of ensuring the continued operation of the plant. When a motor and gearbox become
						misaligned, vibration can travel up the conveyor stream risking the entire unit’s malfunction.
					</p>
					<p>By aligning the gearboxes in a way that provides more accuracy, we can ensure the longevity of
						the plant’s equipment and that it continues to operate efficiently and safely. </p>
					<p>The <?php echo $name; ?> team will be on-site at the Louisiana plant at several points throughout the year to
						carry out maintenance during all planned outages, and we will continue to optimize the
						performance, reliability and safety of the plant’s critical equipment. </p>
				</div>
			</div>
		</section>
	</div>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="kqMdEErlgXaTkgmWNCiXw6_px2NUzMth_gkmHCLSad-ulrWsg4az8tvFLCYhnfFDw_A64m1S3afZjr0LLoKhVrV5Umlpkw-r4NnUlez3w7E=" />
				...
				<input type="hidden" name="fdchk-c0cc0c87-b0e3-4f53-b8c0-8ea5f21cc250"
					value="fdchk-c0cc0c87-b0e3-4f53-b8c0-8ea5f21cc250" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
