        ...
        <section class="mt-16">
            <div class="container xl:max-w-screen-xl">
                <h2 class="heading heading--large heading--dark-green">
                    Our extensive network of skilled professionals and state-of-the-art facilities enables us to deliver
                    exceptional support to construction projects in every corner of the globe.
                </h2>
                ...
                <div class="container xl:max-w-screen-xl">
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pr-8 md:order-1 ">
                            <h2 class="heading mb-0">Our team</h2>
                            <div class="typo">
                                <p>With technical expertise and project management resources spread across key regions,
                                    we deliver local support to our customers, reinforced by a global network of
                                    construction engineering specialists.</p>
                                <p>Our skilled teams of inspectors, technicians, and project managers bring extensive
                                    experience across commercial, residential, and industrial construction projects,
                                    even in the most challenging environments.</p>
                                <p>We are committed to delivering responsive, high-quality services, and our flexible
                                ...
                                <p>While much of our work involves on-site repairs, installations, and upgrades, we also
                                    utilize our state-of-the-art facilities to manage larger, more complex construction
                ...
                <div class="container xl:max-w-screen-xl">
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
                            <img class="w-full mb-8 md:mb-0"
                                src="images/content-images/square/_square/sparrows-facilities.jpg" alt="">
                        </div>
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
                            <h2 class="heading mb-0">Our facilities</h2>
                            <div class="typo">
                                <p><?php echo $name; ?> operates workshop and storage facilities at multiple locations
                                    worldwide. This global infrastructure enables us to provide local, cost-effective,
                                    and efficient solutions for customers with operations across diverse regions.</p>
                                <p>We also offer training facilities strategically located around the globe, delivering
                                    a wide range of tailored and standardized courses that enhance skills and promote
                                    excellence within the construction industry. Our training centers are equipped with
                                    advanced tools and simulators to ensure hands-on, practical learning experiences.
                                </p>
                                <p>Our workshops are certified to ISO 9001 standards and are equipped to handle a
                                    variety of construction-related services, from routine maintenance to full-scale
                                    refurbishments and overhauls of structural, mechanical, and electrical components.
                                </p>
                                <p>Our facilities are capable of delivering a range of specialized services, including:
                                </p>
                                <ul>
                                    <li>Precision machining</li>
                                    <li>Structural fabrication and welding</li>
                                    <li>Surface preparation and abrasive blasting</li>
                                    <li>Protective painting and coating</li>
                                    <li>Load testing for equipment and materials</li>
                                    <li>Pressure testing for structural integrity</li>
                                    <li>Material spark testing</li>
                                    <li>Reverse engineering and custom component design</li>
                                </ul>
                            </div>
                        </div>
