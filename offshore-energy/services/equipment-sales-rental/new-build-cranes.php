...
<main>
    ...
    <div class="block">
        ...
        <section class="">
            <div class="container xl:max-w-screen-xl">
                <h2 class="subheading">
                    We design and manufacture API 2C 8th edition licensed box boom and lattice boom design cranes with a
                    lifting capacity ranging from 1.8 to 200Te.
                </h2>
            </div>
        </section>
        <section class=" mb-16">
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
                            <img class="w-full mb-8 md:mb-0"
                                src="../../../images/content-images/square/_square/ecr-1200-Crane-Sparrows-Group.jpg"
                                alt="">
                        </div>
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
                            <div class="typo">
                                <p>Our crane designs have evolved from the original brands of American Aero, Titan
                                    Cranes and Energy Cranes, re-engineered to enhance performance and capacity. We also
                                    own the intellectual property for Houston Systems and Bucyrus Erie and continues to
                                    support these brands with fabrication, parts, service and engineering upgrades.</p>
                                <p>Our cranes are all based on a variety of standard proven designs which we make
                                    bespoke to your requirements through the high level of customisation we can offer.
                                    We make sure you get the right crane for the job.</p>
                                <h3><strong>Why buy a <?php echo $name; ?> crane?</strong></h3>
                                <ul>
                                    <li>Reliability</li>
                                    <li>Ease of operation</li>
                                    <li>Straightforward maintenance</li>
                                    <li>High level of customisation available</li>
                                    <li>Adaptable to different regional standards</li>
                                    <li>Ability to integrate advanced technology.</li>
                                </ul>
                            </div>
                            <div class="flex flex-wrap items-start -mx-2">
                                <a href="equipment-catalogue.php" class="button button--alt m-2">
                        ...
                        <ul class="flex justify-center flex-wrap md:flex-nowrap">
                                ...
                                <div class="ribbon-block ">
                                    <div class="ribbon-block__img-wrap">
                                        <img class="ribbon-block__img ribbonBlockImage"
                                            src="../../../images/content-images/ribbons/_ribbonImage/crane-manufacturing.jpg"
                                            alt="">
                                    </div>
                            ...
                            <li class="w-full px-4 mb-8 last:mb-0 md:mb-0 md:w-1/5">
                                <div class="ribbon-block  ribbon-block--swap">
                                    <div class="ribbon-block__img-wrap">
                                        <img class="ribbon-block__img ribbonBlockImage"
                                            src="../../../images/content-images/ribbons/_ribbonImage/pedestal-at-barge.jpg"
                                            alt="">
                                    </div>
                                    <h2 class="ribbon-block__title">
                                    ...
                                    <div class="typo">
                                        <p>Our cranes are designed for heavy lifts on fixed or floating platforms, FPSOs
                                            and semi-submersibles and come with a lattice or box boom.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full px-4 mb-8 last:mb-0 md:mb-0 md:w-1/5">
                                <div class="ribbon-block ">
                                    <div class="ribbon-block__img-wrap">
                                        <img class="ribbon-block__img ribbonBlockImage"
                                            src="../../../images/content-images/ribbons/_ribbonImage/box-boom-cranes.jpg"
                                            alt="">
                                    </div>
                                    <h2 class="ribbon-block__title">
                                    ...
                                    <div class="typo">
                                        <p>Fitted with ram luffing booms of box steel construction and designed to
                                            handle heavy lifts at a close radius. The sealed construction of the boom
                                            helps avoid corrosion, making them suitable for use in harsh environments or
                                            for extended periods of rest.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full px-4 mb-8 last:mb-0 md:mb-0 md:w-1/5">
                                <div class="ribbon-block  ribbon-block--swap">
                                    <div class="ribbon-block__img-wrap">
                                        <img class="ribbon-block__img ribbonBlockImage"
                                            src="../../../images/content-images/ribbons/_ribbonImage/lattice-booms.jpg"
                                            alt="">
                                    </div>
                                    <h2 class="ribbon-block__title">
                                    ...
                                    <div class="typo">
                                        <p>Constructed with boom sections made up of lattice steel members that are
                                            attached with tubular chord bolt connections. Designed for lifts that
                                            require a larger radius.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full px-4 mb-8 last:mb-0 md:mb-0 md:w-1/5">
                                <div class="ribbon-block ">
                                    ...
                                    <div class="typo">
                                        <p>Our engineering teams provide rapid, efficient support for all our cranes and
                                            have the in-depth knowledge and expertise which only comes from years of
                                            experience in the field. Should any issues arise, our flying squads are
                                            on-call to solve them at very short notice, worldwide.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="contact-form" id="contactForm">
            <form method="post" action="<?php echo $url; ?>/submit.php">
                ...
                <input type="hidden" name="CRAFT_CSRF_TOKEN"
                    value="xVmGlvDHiUWLmSLZ954j9-qiEWuZIGW-2R-xm5XCJwgpxKEE94Mr7ow_t6Cbv_lw2_sRra7kaZOcxWsD424PiZJvxe7eg0F8Z4vAPZjyW60=" />
                ...
                <input type="hidden" name="fdchk-f8264302-3c82-4690-a252-debc9095cf4b"
                    value="fdchk-f8264302-3c82-4690-a252-debc9095cf4b" />
                <input type="hidden" name="formPayload"
                    value="" />
            </form>
