...
<main>
	...
	<section class="page-banner  page-banner--with-image bgLazy"
		...
		data-src="../../images/content-images/banners/_bannerImage/11620_Crane_Driver_retouch.jpg">
			...
			<div class="flex flex-wrap justify-between md:flex-nowrap">
				<div class="page-banner__overlay ">
					...
					<h2 class="page-banner__subtitle">
						<?php echo $name; ?> is the leading provider of comprehensive lifting and operations management for
						offshore operators.
					</h2>
					<div class="mt-8">
					</div>
		...
		<section class="mt-16 mb-16">
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					<h2 class="heading">
						As the most trusted name in offshore lifting, we can take on the responsibility of managing and
						maintaining your cranes as well as supplying project management for all lifting activities.
					</h2>
				</div>
			</div>
		</section>
					...
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../images/content-images/square/_square/Offshore-crane-operations.jpg" alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<div class="typo">
								<p>As platform cranes are vital to operations, and bring supplies aboard to support
									other critical equipment, it’s essential that they are kept in the best possible
									working order and operated by lifting experts.<br /><br />
									We are on-call to our clients 24 hours a day, 365 days a year, with an average of
									98% up-time over fully managed contracts.</p>
								<p>Crane operators are supplied as part of our fully managed contracts but we can also
									supply them on an ad-hoc basis.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p>Clients with fully managed contracts are provided with a dedicated business manager who
								manages all aspects of contract. They are supported by a team of contract assigned
								engineers and our pool of project engineers who can be deployed onto projects for
								specific activities.<br /><br />We also manage the project planning process, lifting
								equipment, and all personnel and equipment logistics.<br /></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="container xl:max-w-screen-xl">
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../images/content-images/square/_square/Crane-op-supply-vessel-offloading-equipment.jpg"
								alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<h2 class="heading mb-0">Crane operators</h2>
							<div class="typo">
								<p>Our crane operators are the most experienced and highly competent in the offshore
									industry due to our internationally recognised crane operator standard. It’s the
									most rigorous in the world, and we only take on operators who have proved their
									competence.<br /><br />We provide the following crane operators:<br /></p>


								<ul>
									<li>Dual qualified crane operators and mechanics (crane operator qualified to stage
										3 and mechanical, hydraulic, electrical NVQ trade qualified)</li>
									<li>Competent offshore hydraulic and friction clutch crane operators (to stage 3)
									</li>
									<li>Maintenance.</li>
								</ul>
								<p>Platform cranes are critical to operations so their effective maintenance is
									essential to maximise operational efficiency. To support this we provide:<br /></p>



								<ul>
									<li>Mechanical, hydraulic and electrical technicians</li>
									<li>NVQ level 3 and OPITO qualified stage 3 riggers</li>
									<li>LOLER competent staff</li>
									<li>Rigging loft containers and technicians.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<section class="mt-16 mb-16">
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p>We provide multi-skilled deck crew to carry out a number of roles on offshore
								installations including load handler and banksman/slinger to support lifting operations
								and carry out bulk handling and management of all cargo on the assets. Crews can also
								undertake helideck and emergency response functions as necessary.</p>
							<p>Deck crew services can be stand alone or integrated with our crane operations and
								management to provide full accountability of all lifting and handling operations under
								one expert provider.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="4vVtuqgbki03fLn7R_lfNkqAfWR-iB33vVNJjJmfxIXCuvzaR7n0IKuTXIzDY-IYZx6Kjx6DFVI85wcMBMZ3wPYjPfnS3qLxjPWd4yjIhGM=" />
				...
				<input type="hidden" name="fdchk-e586219c-ede1-49c4-8bdf-0abd5bb7869d"
					value="fdchk-e586219c-ede1-49c4-8bdf-0abd5bb7869d" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
