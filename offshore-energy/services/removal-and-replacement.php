...
<main>
	...
	<section class="page-banner  page-banner--with-image bgLazy"
		...
		data-src="../../images/content-images/banners/_bannerImage/Removal-and-replacement.jpg">
			...
			<div class="flex flex-wrap justify-between md:flex-nowrap">
				<div class="page-banner__overlay ">
					...
					<h2 class="page-banner__subtitle">
						<?php echo $name; ?>’s mechanical handling engineers specialise in solving lifting and handling
		...
		<section class="mt-16 mb-16">
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					<h2 class="heading">
						We have engineering support teams and flying squads based worldwide that can be dispatched at
						short notice to help with any problem.
					</h2>
				</div>
			</div>
		</section>
					...
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../images/content-images/square/_square/Cooler-lift.jpg" alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<div class="typo">
								<p>These highly experienced teams provide full engineering support, including project
									management on all aspects of platform work, including the jacking, skidding and
									handling of any component.<br /><br />
									We specialise in the removal and replacement of difficult-to-manoeuvre machinery
									with the minimum impact on a client’s operations.<br /><br />
									Our extensive workshop facilities mean we have the capability to manufacture any
									specialist bespoke equipment required as part of our solution.<br /><br />
									<?php echo $name; ?> designs support packages tailor-made to solve any problem in the
									safest, most efficient and cost-effective manner possible.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="r7ztQvY9Edzm59SAvhCFmmBKpO9L5W-kLMYKvhwIvEGa5Q3rkQa4jeba3HSdRWHptoXn9Odqz_4WLd6HMasFk2e2fstXSdo11Kps0v53yM4=" />
				...
				<input type="hidden" name="fdchk-5f8ff940-11d3-4d61-9f91-702d92aef323"
					value="fdchk-5f8ff940-11d3-4d61-9f91-702d92aef323" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
