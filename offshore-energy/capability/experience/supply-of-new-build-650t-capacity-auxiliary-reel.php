...
<main>
    ...
    <section class="mt-16">
        <div class="container xl:max-w-screen-xl">
            <h2 class="heading heading--large heading--dark-green">
                Supply of new build 650T capacity auxiliary reel
            </h2>
        </div>
    </section>
    <div class="block">
        <section class="">
            <div class="container xl:max-w-screen-xl">
                <h2 class="subheading">
                    When you require new build cable and pipe lay equipment you need experts that can design and
                    manufacture equipment that is fit for purpose.
                </h2>
            </div>
        </section>
                            ...
                            <div class="flex w-full md:w-1/3 px-4 mb-8">
                                <figure class="gallery__item" itemprop="associatedMedia" itemscope
                                    ...
                                    <a class="gallery__link galleryItem"
                                        href="../../../images/content-images/case-studies/oilandgas/cpls/reel-awaiting-transportation.jpg"
                                        itemprop="contentUrl" data-height="909" data-width="1364" data-pos="1"
                                        data-caption="The reel awaiting transportation.">
	...
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
                                        ...
                                        <img class="gallery__image"
                                            src="../../../images/content-images/case-studies/oilandgas/cpls/_contentImage/reel-awaiting-transportation.jpg"
                                            alt="" itemprop="thumbnail">
                                    </a>
                                    <div class="flex items-center mt-5">
                                        <div class="gallery__info">
                                            <p class="font-bold">
                                                The reel awaiting transportation.
                                            </p>
                                        </div>
                                    </div>
                                </figure>
                            ...
                            <div class="flex w-full md:w-1/3 px-4 mb-8">
                                <figure class="gallery__item" itemprop="associatedMedia" itemscope
                                    itemtype="http://schema.org/ImageObject">
                                    <a class="gallery__link galleryItem"
                                        href="../../../images/content-images/case-studies/oilandgas/cpls/reel-lifted-off-dock.jpg"
                                        itemprop="contentUrl" data-height="909" data-width="1364" data-pos="2"
                                        data-caption="The reel being lifted off the dock.">
                                        <span class="circle-btn circle-btn--white">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 36 36"
                                                xml:space="preserve">
                                                <path d="M24,0l4.6,4.6l-5.8,5.7l2.8,2.8l5.7-5.8L36,12V0H24z M0,12l4.6-4.6l5.7,5.8l2.8-2.8L7.4,4.6L12,0H0V12z M12,36
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
                                        ...
                                        <img class="gallery__image"
                                            src="../../../images/content-images/case-studies/oilandgas/cpls/_contentImage/reel-lifted-off-dock.jpg"
                                            alt="" itemprop="thumbnail">
                                    </a>
                                    <div class="flex items-center mt-5">
                                        <div class="gallery__info">
                                            <p class="font-bold">
                                                The reel being lifted off the dock.
                                            </p>
                                        </div>
                                    </div>
                                </figure>
        ...
        <section class="">
            <div class="container xl:max-w-screen-xl">
                <div class="typo">
                    ...
                    <ul>
                        <li>Engineering support to ensure the equipment was fit for purpose</li>
                        <li>Delivery of equipment on a short time scale</li>
                        <li>Technical support to ensure correct installation.</li>
                    </ul>
                    <h3><strong>Challenge</strong></h3>
                    <p>When you require new build cable and pipe lay equipment you need experts that can design and
                        manufacture equipment that is fit for purpose.</p>
                    <p>Our client required to install an existing lay spread to a brand new vessel and they contracted
                        us to supply and install a new 650T capacity auxiliary reel.</p>
                    <h3><strong>Solution</strong></h3>
                    <ul>
                        <li>The reel incorporated a new support and drive system in order to accommodate flexible pipes
                            ranging between 3” and 8” in diameter</li>
                        <li>After manufacture the reel was shipped to a ship yard in Finland for installation upon the
                            clients vessel and commissioning and sea trials took place in Scotland at Invergordon and
                            Evanton.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Design</li>
                        <li>Procurement</li>
                        <li>Management of fabrication</li>
                        <li>Audit reporting</li>
                        <li>Commissioning</li>
                        <li>Supply of offshore personnel.</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <div class="contact-form" id="contactForm">
            <form method="post" action="<?php echo $url; ?>/submit.php">
                ...
                <input type="hidden" name="CRAFT_CSRF_TOKEN"
                    value="lBPWR5FOjnOq-HBiQjXNuZeDc06Mff1YLxBltNYhCGiuCJQ76DWizN1153H6Nv5G-ppDFhtPh93h5Akm9jOXb2RgEcGdYG4c4Ef1AodE0o8=" />
                ...
                <input type="hidden" name="fdchk-4a5d3fd5-4161-4b89-8a1a-4ed4eddf9272"
                    value="fdchk-4a5d3fd5-4161-4b89-8a1a-4ed4eddf9272" />
                <input type="hidden" name="formPayload"
                    value="" />
            </form>
