...
<main>
    ...
    <section class="mt-16">
        <div class="container xl:max-w-screen-xl">
            <h2 class="heading heading--large heading--dark-green">
                Five-yearly overhaul and recertification for multiple pieces of drilling equipment
            </h2>
        </div>
    </section>
    <div class="block">
        <section class=" mb-16">
            <div class="container xl:max-w-screen-xl">
                <h2 class="subheading">
                    Scheduled maintenance is necessary to ensure safety and efficiency of future drilling operations
                </h2>
            </div>
        </section>
                            ...
                            <div class="flex w-full md:w-1/3 px-4 mb-8">
                                <figure class="gallery__item" itemprop="associatedMedia" itemscope
                                    ...
                                    <a class="gallery__link galleryItem"
                                        href="../../../images/content-images/case-studies/Wrangler-5000-catwalk-1.jpg"
                                        itemprop="contentUrl" data-height="768" data-width="1024" data-pos="1"
                                        data-caption="Wrangler 5000 catwalk">
	...
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
                            ...
                            <div class="flex w-full md:w-1/3 px-4 mb-8">
                                <figure class="gallery__item" itemprop="associatedMedia" itemscope
                                    itemtype="http://schema.org/ImageObject">
                                    <a class="gallery__link galleryItem"
                                        href="../../../images/content-images/case-studies/Iron-roughneck.jpg"
                                        itemprop="contentUrl" data-height="1280" data-width="719" data-pos="2"
                                        data-caption="Iron roughneck">
                                        <span class="circle-btn circle-btn--white">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 36 36"
                                                xml:space="preserve">
                                                <path d="M24,0l4.6,4.6l-5.8,5.7l2.8,2.8l5.7-5.8L36,12V0H24z M0,12l4.6-4.6l5.7,5.8l2.8-2.8L7.4,4.6L12,0H0V12z M12,36
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
                                        ...
                                        <img class="gallery__image"
                                            src="../../../images/content-images/case-studies/_contentImage/Iron-roughneck.jpg"
                                            alt="" itemprop="thumbnail">
                                    </a>
                                    <div class="flex items-center mt-5">
                                        <div class="gallery__info">
                            ...
                            <div class="flex w-full md:w-1/3 px-4 mb-8">
                                <figure class="gallery__item" itemprop="associatedMedia" itemscope
                                    itemtype="http://schema.org/ImageObject">
                                    <a class="gallery__link galleryItem"
                                        href="../../../images/content-images/case-studies/OAC-crane.jpg"
                                        itemprop="contentUrl" data-height="768" data-width="1024" data-pos="3"
                                        data-caption="OAC crane">
                                        <span class="circle-btn circle-btn--white">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 36 36"
                                                xml:space="preserve">
                                                <path d="M24,0l4.6,4.6l-5.8,5.7l2.8,2.8l5.7-5.8L36,12V0H24z M0,12l4.6-4.6l5.7,5.8l2.8-2.8L7.4,4.6L12,0H0V12z M12,36
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
                                        ...
                                        <img class="gallery__image"
                                            src="../../../images/content-images/case-studies/_contentImage/OAC-crane.jpg"
                                            alt="" itemprop="thumbnail">
                                    </a>
                                    <div class="flex items-center mt-5">
                                        <div class="gallery__info">
        ...
        <section class="">
            <div class="container xl:max-w-screen-xl">
                <div class="typo">
                    ...
                    <ul>
                        <li>Single point of contact for work across multiple pieces of drilling equipment</li>
                        <li>Work scope completed to tight timescale avoiding disruption to operations</li>
                        <li>Supplied highly skilled multi-disciplined technicians working to Original Equipment
                            Manufacturer (OEM) standard</li>
                        <li>Provision of multiple services by <?php echo $name; ?> enabled a cost-effective solution for
                            the client
                        </li>
                    </ul>
                    <h3><strong>Challenge</strong></h3>
                    <ul>
                        <li>End user has OEM only policy</li>
                        <li>OEM did not have the facilities to undertake scope of work in country, so was required to
                            seek alternative solution</li>
                        <li>Each item required total strip down, inspection and rebuild with new parts</li>
                        <li>All pieces of equipment required full repaint to match OEM paint specifications</li>
                        <li>The workscope needed to be completed within the overall rig major maintenance timeframe of
                            30 days to avoid disruption to operations.</li>
                    </ul>
                    <h3><strong>Solution</strong></h3>
                    <ul>
                        <li>The client recognised Sparrows’ service capability as the most suitable for the project and
                            contracted us to provide overhaul and refurbishment of their Wrangler 5000 catwalk, OAC
                            crane and iron roughneck</li>
                        <li><?php echo $name; ?> conducted full strip down, inspection and the blasting and painting of
                            parts before
                            rebuilding with new components to as-new condition</li>
                        <li>We completed 400 full hydraulic hose changeouts on all drilling equipment within the
                            workscope</li>
                        <li>RAL codes for painting differ between the UAE and US so <?php echo $name; ?> conducted paint
                            specification matching by working with a separate manufacturer to provide samples as close
                            as possible to the original paint colour</li>
                        <li><?php echo $name; ?> provided overhaul and recertification services for scope of work
                            including working
                            facilities, suitable personnel, hydraulics, blasting and painting, local supply chain
                            expertise, welding and full project engineering support</li>
                        <li>The client directed project management and communication between all parties.</li>
                    </ul>
                    <h3><strong>Summary</strong></h3>
                    <p>Integrated solutions<br /></p>
                    <ul>
                        <li>Reliability centred maintenance</li>
                        <li>Mechanical handling</li>
                        <li>Equipment upgrade</li>
                        <li>Fault finding and repair</li>
                        <li>Hydraulic system management</li>
                    </ul>
                    <p>Capabilities/services</p>
                    <ul>
                        <li>Multi-discipline engineering / design</li>
                        <li>Rigging/lifting</li>
                        <li>Maintenance/servicing/refurbishment</li>
                        <li>Inspection/testing/rope access</li>
                        <li>Fluid power/hydraulics</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <div class="contact-form" id="contactForm">
            <form method="post" action="<?php echo $url; ?>/submit.php">
                ...
                <input type="hidden" name="CRAFT_CSRF_TOKEN"
                    value="467ju00s4_ZXPlzpAsfe6nByWPK5pPMM9xKuR9sTQXIA4B20qE2ej6rI0o0mVJPDB1xvnVu9lI4GFSKaw-qZO7xi2jKQUicGTq98jcc87sw=" />
                ...
                <input type="hidden" name="fdchk-3b4a8429-3c49-4beb-8b61-6a847286d233"
                    value="fdchk-3b4a8429-3c49-4beb-8b61-6a847286d233" />
                <input type="hidden" name="formPayload"
                    value="" />
            </form>
