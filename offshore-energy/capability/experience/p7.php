...
<main>
	...
	<section class="my-16">
		<div class="container">
			...
			<form class="mb-16" action="<?php echo $url; ?> /offshore-energy/capability/experience/p7">
				<div class="-mx-4">
			...
			<div class="-mx-4">
				<ul class="flex flex-wrap">
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="glen-lyon-lifting-support-during-hook-up-and-commissioning.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/_contentImage/glen-lyon.jpg"
								alt="">
							<ul class="news-block__list">
								...
								<li>
									...
									<span class="font-bold">Korea</span>
									<span class="font-bold">Norway</span>
								</li>
							</ul>
							<h2 class="news-block__title">Glen Lyon lifting support during hook-up and commissioning
							</h2>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="flare-tip-platform-grating-change-out.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/_contentImage/trial.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Asset:
									<span class="font-bold">Fixed platform</span>
								</li>
								<li>
									Location:
									<span class="font-bold">UK</span>
							...
							<h2 class="news-block__title">Flare tip platform grating change out</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="fateh-lq2-crane-replacement-project.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/_contentImage/Installation_Chasis_with_ECR20.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Asset:
									<span class="font-bold">Fateh LQ2 platform</span>
								</li>
								<li>
									Location:
									<span class="font-bold">Dubai, UAE</span>
								</li>
							</ul>
							<h2 class="news-block__title">Fateh LQ2 crane replacement project</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="crane-removal-refurbishment-and-reinstallation.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/_contentImage/Full_boom_refurbishment.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Client:
									<span class="font-bold">Spirit Energy</span>
								</li>
								<li>
									Asset:
								...
								<li>
									Location:
									<span class="font-bold">Morecambe Bay, UK</span>
								</li>
							</ul>
							<h2 class="news-block__title">Crane removal, refurbishment and reinstallation</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="crane-life-extension-project.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/_contentImage/platform-crane02.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Asset:
							...
							<h2 class="news-block__title">Crane life extension project</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="crane-davit-arm-changeout-with-spider-crane.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/_contentImage/spidercrane.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Asset:
							...
							<h2 class="news-block__title">Crane davit arm changeout with spider crane</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
			...
			<div class="-mx-4">
				<div class="pagination">
					<a class="button button--base" href="p6.php">Previous</a> <a class="circle-btn circle-btn--large"
						href="p2.php">2</a>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="x7fg2Xi87Zg7YA1WmNSAJ7DD-9ATNrY5fbbErXKpOBqaCTsDI-_T5o7R0e8TxJ2tawI-IsGuykPGpIG4aXjcDjbGsNg56F5u1EZaOkyeo6U=" />
				...
				<input type="hidden" name="fdchk-0a7653bb-432a-47ef-8c68-d69fad092232"
					value="fdchk-0a7653bb-432a-47ef-8c68-d69fad092232" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
