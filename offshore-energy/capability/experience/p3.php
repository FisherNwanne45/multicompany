...
<main>
	...
	<section class="my-16">
		<div class="container">
			...
			<form class="mb-16" action="<?php echo $url; ?> /offshore-energy/capability/experience/p3">
				<div class="-mx-4">
			...
			<div class="-mx-4">
				<ul class="flex flex-wrap">
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block"
							href="flushing-and-re-commissioning-of-fire-pump-hydraulic-drive-system.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/hydraulic/_contentImage/fpso.jpg"
								alt="">
							...
							<h2 class="news-block__title">Flushing and re-commissioning of fire pump hydraulic drive
								system</h2>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="hydraulic-pipework-pressure-testing-flushing.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/drilling-and-hydraulic/_contentImage/Hydraulicpipeworkpressuretestingflushing.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Asset:
									<span class="font-bold">Drilling rig</span>
								</li>
								<li>
									Location:
									<span class="font-bold">UK</span>
							...
							<h2 class="news-block__title">Hydraulic pipework pressure testing &amp; flushing</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="drill-floor-hydraulic-system-flushing-to-remove-contamination.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/drilling-and-hydraulic/_contentImage/Drill_floor_HPU.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Location:
							...
							<h2 class="news-block__title">Drill floor hydraulic system flushing to remove contamination
							</h2>
							<span class="button button--base">
								Read more
							</span>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="drilling-equipment-five-yearly-inspections-and-overhaul.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/drilling/_contentImage/Mud-pump-reassembly.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Asset:
									<span class="font-bold">Jack-up drilling rig</span>
								</li>
								<li>
									Location:
							...
							<h2 class="news-block__title">Drilling equipment five-yearly inspections and overhaul</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block"
							href="fpso-risers-pulled-in-hooked-up-and-commissioned-on-new-north-sea-asset.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting-and-other/_contentImage/Rope-Access-2.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Client:
									<span class="font-bold">BW Offshore</span>
								</li>
								<li>
									Asset:
									<span class="font-bold">FPSO</span>
							...
							<h2 class="news-block__title">FPSO risers pulled in, hooked up and commissioned on new North
								Sea asset</h2>
							<span class="button button--base">
								Read more
							</span>
					...
					<li class="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
						<a class="news-block" href="export-hose-change-out.php">

							<img class="latest-block__img"
								src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting-and-hydraulic/_contentImage/ubend.jpg"
								alt="">
							<ul class="news-block__list">
								<li>
									Asset:
							...
							<h2 class="news-block__title">Export hose change out</h2>
							<span class="button button--base">
								Read more
							</span>
						</a>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="XxMdv54RUVgmen8reJ47ujF_VtWPyhlpOXi8NeM_LFoTTogXIE3uNBZ1LIn1aSFtdhhMXyHkcd5HGCy99YRzXnIIyECofkouXQHpLk88nnc=" />
				...
				<input type="hidden" name="fdchk-23f3f8c6-b941-4d7c-98b7-d1d1ac44a64e"
					value="fdchk-23f3f8c6-b941-4d7c-98b7-d1d1ac44a64e" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
