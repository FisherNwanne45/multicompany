...
<main>
    ...
    <section class="mt-16">
        <div class="container xl:max-w-screen-xl">
            <h2 class="heading heading--large heading--dark-green">
                Flare tip platform grating change out
            </h2>
        </div>
    </section>
    <div class="block">
        <section class="">
            <div class="container xl:max-w-screen-xl">
                <h2 class="subheading">
                    When you need to access areas of significant height and inaccessibility, a comprehensive lift plan
                    maximises efficiency and mitigates risks.
                </h2>
            </div>
        </section>
                            ...
                            <div class="flex w-full md:w-1/3 px-4 mb-8">
                                <figure class="gallery__item" itemprop="associatedMedia" itemscope
                                    ...
                                    <a class="gallery__link galleryItem"
                                        href="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/trial.jpg"
                                        itemprop="contentUrl" data-height="910" data-width="1364" data-pos="1"
                                        data-caption="Onshore trial and assembly.">
	...
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
                            ...
                            <div class="flex w-full md:w-1/3 px-4 mb-8">
                                <figure class="gallery__item" itemprop="associatedMedia" itemscope
                                    itemtype="http://schema.org/ImageObject">
                                    <a class="gallery__link galleryItem"
                                        href="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/platform-flare-tip.jpg"
                                        itemprop="contentUrl" data-height="910" data-width="1364" data-pos="2"
                                        data-caption="Aerial view of the flare tip and platform.">
                                        <span class="circle-btn circle-btn--white">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 36 36"
                                                xml:space="preserve">
                                                <path d="M24,0l4.6,4.6l-5.8,5.7l2.8,2.8l5.7-5.8L36,12V0H24z M0,12l4.6-4.6l5.7,5.8l2.8-2.8L7.4,4.6L12,0H0V12z M12,36
	l-4.6-4.6l5.8-5.7l-2.8-2.8l-5.7,5.8L0,24v12H12z M36,24l-4.6,4.6l-5.7-5.8l-2.8,2.8l5.8,5.7L24,36h12V24z" />
                                        ...
                                        <img class="gallery__image"
                                            src="../../../images/content-images/case-studies/oilandgas/cranes-and-lifting/_contentImage/platform-flare-tip.jpg"
                                            alt="" itemprop="thumbnail">
                                    </a>
                                    <div class="flex items-center mt-5">
                                        <div class="gallery__info">
                                            <p class="font-bold">
                                                Aerial view of the flare tip and platform.
                                            </p>
                                        </div>
                                    </div>
                                </figure>
        ...
        <section class="">
            <div class="container xl:max-w-screen-xl">
                <div class="typo">
                    ...
                    <ul>
                        <li>Efficient and cost effective solution to provide confidence in the safety of the flare tip
                            platform</li>
                        <li>Bespoke solution which utilised existing resources to minimise costs</li>
                        <li>Full lift plan to mitigate risks.</li>
                    </ul>
                    <h3><strong>Challenge</strong></h3>
                    <p>When you need to access areas of significant height and inaccessibility, a comprehensive lift
                        plan maximises efficiency and mitigates risks.</p>
                    <p>To ensure they maintain the highest safety standards our client engaged us to produce and test a
                        safe solution and method of access and replacement for panels on their flare tip platform.</p>


                    <h3><strong>Solution</strong></h3>
                    <p>We supplied our client with a comprehensive lift plan for the safe method of access and
                        replacement of the panels they wished to replace</p>
                    <ul>
                        <li>A winch which was the primary lifting source was mounted to the base of the flare tower
                            adjacent to the mechanical handling hatch</li>
                        <li>The FEED study identified and developed several options for the lifting appliance which
                            included installing either an a-frame or davit steelwork structure</li>
                        <li>The final recommendation was to utilise an existing <?php echo $name; ?> slewing davit
                            design, tailored
                            specifically for the application, mounted at the mechanical handling hatch</li>
                        <li>This was accompanied by a specially designed deck trolley which incorporated a bolt on
                            slewing davit for handling and moving the grating panels on the access platform</li>
                        <li>Once the design was accepted, we commenced the fabrication and testing of the equipment</li>
                        <li>Testing took place on a full scale area plan replica constructed from scaffolding materials
                            onshore in order to enable testing of the system under controlled conditions</li>
                    </ul>
                    <h3><strong>Summary</strong></h3>
                    <ul>
                        <li>FEED study (front end engineering and design)</li>
                        <li>Concept solution design proposal</li>
                        <li>Detailed design of davit and trolley appliances and associated materials</li>
                        <li>Fabrication / materials and coatings</li>
                        <li>Equipment build / assembly</li>
                        <li>Production of lifting plans</li>
                        <li>Provision of rental equipment</li>
                        <li>Documentation packaging including: lifting plans / work packs / certification and testing
                        </li>
                        <li>Specialist contractor liaison onshore / offshore</li>
        ...
        <div class="contact-form" id="contactForm">
            <form method="post" action="<?php echo $url; ?>/submit.php">
                ...
                <input type="hidden" name="CRAFT_CSRF_TOKEN"
                    value="D45xNFL_p9clAxD2QrdWpNHlB6BjWxNVbYnLEDGH3hgUQXzIVXnDS0boQAI5h9fidWEjghvNHMCngn3IGRV5Yib5v2V6xrhsWg4d8ToIswg=" />
                ...
                <input type="hidden" name="fdchk-fb7d57bf-114f-4009-8105-d85edc1482d5"
                    value="fdchk-fb7d57bf-114f-4009-8105-d85edc1482d5" />
                <input type="hidden" name="formPayload"
                    value="" />
            </form>
