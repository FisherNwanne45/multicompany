...
<main>
	...
	<div class="block">
		...
		<section class=" mb-16">
			<div class="container xl:max-w-screen-xl">
				<h2 class="subheading">
					Ensuring the safety and reliability of lifting operations and raising standards across the offshore
					...
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../../images/content-images/square/_square/Crane-lifting.jpg" alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<div class="typo">
								<p>Our offshore origins trace back to 1975 when we first started providing specialist
									lifting and handling services to offshore energy operators. </p>
								<p>Since then, we’ve built our reputation as industry leaders in cranes and lifting
									operations across the offshore industry. From design and inspection to maintenance
									and repair, we have the knowledge and expertise to ensure the reliability and safety
									of critical lifting equipment.</p>
								<p>Our predictive approach to maintenance ensures equipment availability and prevents
									unscheduled downtime. With our global flying squad of technicians on-call 24/7,
									support can be dispatched at short notice if a problem occurs. Our teams are
									specialists in mechanical, hydraulic and electrical equipment and can undertake
									troubleshooting and repairs on all crane and lifting equipment.</p>
								<p>As well as our in-field support, we also have a global multi-discipline engineering
									team and extensive workshop facilities located across the globe where we can carry
									out maintenance, overhaul, inspection, repair and refurbishment work that can’t be
									completed offshore. </p>
								<p>We work on all offshore crane types as well as other fixed and loose lifting
									accessories such as rigging lofts, lifeboat davits, padeyes, runway beams, jacks,
									chainfalls, slings (wire and soft), turnbuckles, and shackles. Our services also
									cover equipment being lifted such as cargo carrying units and pipe racks. </p>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="oI9tbGA_YWSN9yqkRm8sVwQMKgP_R7WnZEhHy8poNEyqEJzmvZa-OenpXFoLRxFR3ZUZ0B8VZjNya1BrhQnfkC84M76BKVI45F_939Lnzno=" />
				...
				<input type="hidden" name="fdchk-0bfb4f6e-c976-4f0a-81fc-148d9032834a"
					value="fdchk-0bfb4f6e-c976-4f0a-81fc-148d9032834a" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
