...
<main>
    ...
    <div class="block">
        ...
        <section class="">
            <div class="container xl:max-w-screen-xl">
                <h2 class="subheading">
                    Ensuring the integrity of hydraulic equipment and systems within the global offshore energy
                    industry.
                </h2>
            </div>
        </section>
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-2/5 md:flex md:items-center  md:pr-8 ">
                            <img class="w-full mb-8 md:mb-0"
                                src="../../../images/content-images/square/_square/Hydraulic-control-panel.jpg" alt="">
                        </div>
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
                            <div class="typo">
                                <p>Sparrows’ possesses a great depth of capability, experience and knowledge across its
                                    comprehensive fluid power services.</p>
                                <p>With a large team of engineers and technicians located around the world, we provide a
                                    range of services from the design and manufacture of new hydraulic equipment to
                                    inspection, repair and overhaul. </p>
                                <p>Our design and manufacture services include standard and custom-built machinery in
                                    addition to offering a suite of rental equipment. Our fluid power engineers can
                                    advise on design, consultancy, system performance review and optimisation,
                                    obsolescence review and root cause analysis.<br /><br />
                                    We have experience working with a wide range of pump and motor manufacturers and we
                                    are an approved authorised repair centre for Parker pumps and motors, as well as a
                                    distributor for Bosch Rexroth, MP Filtri and Webtec.<br /><br />
                                    Typical services include:<br /></p>
                                <ul>
                                    <li>On-site assistance in troubleshooting, maintenance, testing and repair</li>
                                    <li>Performance analysis and optimisation</li>
                                    <li>Advice on choosing the correct components</li>
                                    <li>Providing components ‘ready for application’</li>
                                    <li>Flushing, pipework installation and pressure testing</li>
                                    <li>‘Health-checks’ as part of fully managed service plans</li>
                                    <li>A report on every unit tested.</li>
                                </ul>
                                <p>
                                    We also support clients with modification and upgrade of existing systems which can
                                    be a cost and time effective solution.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container xl:max-w-screen-xl">
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-2/5 md:flex md:items-center  md:pl-8 md:order-2 ">
                            <img class="w-full mb-8 md:mb-0"
                                src="../../../images/content-images/square/_square/Hydraulic-mooring-winch.jpg" alt="">
                        </div>
                        <div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pr-8 md:order-1 ">
                            <h2 class="heading mb-0">Hydraulic system management</h2>
                            <div class="typo">
                                <p>Our tailored packages are designed to optimise machine safety, operating costs,
                                    reliability and up-time using a proactive and condition-based approach. </p>
                                <p>We can manage whole systems or individual pieces of equipment. Our approach is to
                                    assess, maintain, monitor and improve. As part of our service we deliver condition
                                    evaluation and compliance reports and produce planned predictive maintenance
                                    routines.</p>
                                <p>Visit our services pages to find out more information about how we support customers
                                    at every stage of the equipment lifecycle.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contact-form" id="contactForm">
            <form method="post" action="<?php echo $url; ?>/submit.php">
                ...
                <input type="hidden" name="CRAFT_CSRF_TOKEN"
                    value="gIDEd077C8nPQRSwO4-9PYQ9_RJ-zh6PQarjEFPjf_VfV7S9grRL5snm9UElg3v8nyMnxGL191nyWod6BIB0uAral2UYohmBERjVhO3FO6U=" />
                ...
                <input type="hidden" name="fdchk-7f2aab6a-cb13-450c-bcf5-bcc0792cbace"
                    value="fdchk-7f2aab6a-cb13-450c-bcf5-bcc0792cbace" />
                <input type="hidden" name="formPayload"
                    value="" />
            </form>
