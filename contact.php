...
<main>
    ...
    <div class="block">
        <section class="mt-16 mb-16">
            <div class="container xl:max-w-screen-xl">
                <h2 class="heading heading--large  heading--green">
        ...
        <section class="mt-16 mb-16">
            <div class="container xl:max-w-screen-xl">
                ...
                <div
                    ...
                    <h3 style="color: green; text-align: center;">Your submission has been sent successfully!</h3>
                </div>
                ...
                <div
                    ...
                    <h3 style="color: red; text-align: center;">There was an error while sending your message. Please
                        try again.</h3>
                </div>
                <?php endif; ?>
                <?php else: ?>
    ...
    <div class="container xl:max-w-screen-xl">
        ...
        <div class="contact-form" id="contactForm">
            <form method="post" action="<?php echo $url; ?>/submit.php">
                ...
                <!--<input type="hidden" name="adminmail" value="<?php echo $url; ?>" />
                <input type="hidden" name="action" value="express-forms/submit" />-->
                <input type="hidden" name="CRAFT_CSRF_TOKEN"
                    value="bt8rkudNhyeLHdlSH65MDGiTgUPqkoA1NzkQT-2yOXF0mRIJ0N_ELSe5GqSMNfcS23_qJkbUBmge9PsrkNzqAnxJZDqm818FOtZzML-utG4=" />
                ...
                <input type="hidden" name="fdchk-9cfbfbf0-f5d1-49b8-b55b-203071cf8bd3"
                    value="fdchk-9cfbfbf0-f5d1-49b8-b55b-203071cf8bd3" />
                <input type="hidden" name="formPayload"
                    value="" />
            </form>
