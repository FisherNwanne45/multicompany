...
<main>
	...
	<div class="block">
		...
		<section class=" mb-16">
			<div class="container xl:max-w-screen-xl">
				<h2 class="subheading">
					<?php echo $name; ?> has a long history of providing opportunities to people beginning their careers in
					the energy industry as graduates and apprentices.
				</h2>
			</div>
		</section>
				...
				<div class="container xl:max-w-screen-xl">
					<div class="flex flex-wrap">
						...
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pl-8 ">
							<div class="typo">
								<p>This commitment to developing our own talent has been integral to our success as a
									company with the knowledge and ability of our staff marking us out as the partner of
									choice for many clients.<br /></p>
								<p>A high percentage of our managers and senior engineers began their working lives in
									our graduate and apprentice programmes that provided them with the core skills to
									move up the career ladder.</p>
								<p>We follow IMechE, IET and Modern Apprenticeship processes to ensure a well-rounded
									experience focused on achieving competency. A large number of young graduates join
									our Engineering Development Scheme (EDS) that has been designed to nurture talent
									and provide opportunities to progress within the business.</p>
								<p>Our commitment to the next generation also involves us working in partnership with
									several universities and secondary schools to provide student placements. In
									addition, we provide mentors to help develop Science, Technology, Engineering and
									Mathematics (STEM) skills amongst school pupils.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container xl:max-w-screen-xl">
					<div class="flex flex-wrap">
						<div class="w-full md:w-2/5 md:flex md:items-center  md:pl-8 md:order-2 ">
							<img class="w-full mb-8 md:mb-0"
								src="../../images/content-images/leadership-team/_square/Ewen-Kerr-Sparrows-Group.jpg"
								alt="">
						</div>
						<div class="w-full flex flex-col justify-center items-start md:w-3/5  md:pr-8 md:order-1 ">
							<h2 class="heading mb-0">“Apprentices and graduates are hugely important to Sparrows. We
								pride ourselves on providing all of our engineering services in-house and the best way
								to do this is to keep a conveyor-belt of talent through the business.”</h2>
							<div class="typo">
								<p>Ewen Kerr, Chief Technical Officer</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="OT33tF2xUsyXRv-LAi5wDVUCxI29mx8U_GMwMW8B2myt5tINXuJVzXBbxoI2ySL5xyTM_1tUOmkjZb7lx9V1I7cTREQkQLwY46mzNDGTJY4=" />
				...
				<input type="hidden" name="fdchk-4d4329da-0419-4dfe-9062-8f548cf913fd"
					value="fdchk-4d4329da-0419-4dfe-9062-8f548cf913fd" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
