...
<main>
	...
	<section class="page-banner  page-banner--with-image bgLazy"
		...
		data-src="../images/content-images/banners/_bannerImage/accreditations.jpg">
				...
				<div class="container xl:max-w-screen-xl">
					...
					<div class="-mx-4">
						<div class="flex flex-wrap">
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/Opito.jpg" alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img" src="../images/content-images/logos/_squareFit/abs.jpg"
										alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/ukas.jpg" alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/i-mech-e.jpg" alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img" src="../images/content-images/logos/_squareFit/soe.jpg"
										alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img" src="../images/content-images/logos/_squareFit/iet.jpg"
										alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/BFPA_Distributor_Member_Logo.png"
										alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img" src="../images/content-images/logos/_squareFit/eal.jpg"
										alt="">
								</div>
							</div>
						</div>
				...
				<div class="container xl:max-w-screen-xl">
					...
					<div class="-mx-4">
						<div class="flex flex-wrap">
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img" src="../images/content-images/logos/_squareFit/bsi.jpg"
										alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img" src="../images/content-images/logos/_squareFit/dnv.jpg"
										alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img" src="../images/content-images/logos/_squareFit/api.jpg"
										alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/CEPlus.png" alt="">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="-mx-4">
						<div class="flex flex-wrap">
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/leea.jpg" alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/drops.jpg" alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/IRATA.jpg" alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
									<img class="logo-block__img"
										src="../images/content-images/logos/_squareFit/sprat.jpg" alt="">
								</div>
							</div>
							<div class="flex px-4 w-1/2 md:w-1/3 lg:w-1/5">
								<div class="logo-block">
		...
		<div class="contact-form" id="contactForm">
			<form method="post" action="<?php echo $url; ?>/submit.php">
				...
				<input type="hidden" name="CRAFT_CSRF_TOKEN"
					value="q9T9AP4iQVB5WiD-LZAV_U9C2CP-F761N3LArYvFx3vyt0_ISDn_FOKyzDaVWjFlKTgTinTqX5k5JaJLhFnUgnwCtNjAhKEPvPgu8SdIj1c=" />
				...
				<input type="hidden" name="fdchk-162e171a-fdb7-46f0-b70f-4b8a08d48b17"
					value="fdchk-162e171a-fdb7-46f0-b70f-4b8a08d48b17" />
				<input type="hidden" name="formPayload"
					value="" />
			</form>
