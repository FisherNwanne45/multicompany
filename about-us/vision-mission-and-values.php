			...
			<div class="banner banner--">
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p>The <?php echo $name; ?> Group is committed to supporting the global energy industry
								develop an efficiency driven culture by optimising the performance, reliability and
								safety of critical equipment and people through the provision of our engineered products
								and services.</p>
						</div>
					</div>
					<h2 class="heading">
						Our vision / strategic goal
					</h2>
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p>The <?php echo $name; ?> Group will continue to grow as a leading energy services
								contractor by consistently providing assured delivery to customers through the provision
								of high quality specialist equipment and integrated engineering services.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="base-banner">
				<div class="container xl:max-w-screen-xl">
					<h2 class="heading heading--orange">
						Our values represent the way we do business and interact with all of our key stakeholders
					</h2>
					<ul class="timeline timeline--dna">
						<li class="timeline-item">
							<div class="w-2/5 items-center hidden md:flex"></div>
							<div class="flex w-1/3 md:w-1/5">
								<img src="../img/dna-start.png" alt="">
							</div>
							<div class="flex items-center w-2/3 md:w-2/5"></div>
						</li>
						<li class="timeline-item">
							<div class="w-2/5 items-center hidden md:flex">
								<div class="speech-bubble speech-bubble--left  md:hidden">
									<h2 class="speech-bubble__title">
										HSEQ
									</h2>
									<div class="typo">
										<p>We are committed to upholding the highest standards of health, safety,
											environment and quality globally.</p>
									</div>
								</div>
							</div>
							<div class="flex w-1/3 md:w-1/5">
								<img src="../img/dna-strand.png" alt="">
							</div>
						...
						<li class="timeline-item">
							<div class="w-2/5 items-center hidden md:flex">
								<div class="speech-bubble speech-bubble--left ">
									...
									<div class="typo">
										<p>We prioritise being transparent and reliable to consistently deliver a high
											quality service to all of our clients.</p>
									</div>
								</div>
							</div>
							<div class="flex w-1/3 md:w-1/5">
							...
							<div class="flex items-center w-2/3 md:w-2/5">
								<div class="speech-bubble speech-bubble--right  md:hidden">
									<h2 class="speech-bubble__title">
										Trust
									</h2>
									<div class="typo">
						...
						<li class="timeline-item">
							<div class="w-2/5 items-center hidden md:flex">
								<div class="speech-bubble speech-bubble--left  md:hidden">
									...
									<div class="typo">
										<p>We endeavour to provide a supportive and engaging working environment that
											allows people to thrive.</p>
									</div>
								</div>
							</div>
							<div class="flex w-1/3 md:w-1/5">
						...
						<li class="timeline-item">
							<div class="w-2/5 items-center hidden md:flex">
								<div class="speech-bubble speech-bubble--left ">
									...
									<div class="typo">
										<p>We strive to optimise productivity through the delivery of lean value-driven
						...
						<li class="timeline-item">
							<div class="w-2/5 items-center hidden md:flex">
								<div class="speech-bubble speech-bubble--left  md:hidden">
									...
									<div class="typo">
										<p>We behave in a manner that reflects mutual respect, honesty and ethical
											business practice in all of our dealings.</p>
									</div>
								</div>
							</div>
							<div class="flex w-1/3 md:w-1/5">
