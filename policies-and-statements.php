			...
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<p><?php echo $name; ?> is committed to the highest standards of business ethics and
								corporate social responsibility toward our clients, our staff, our suppliers and the
								communities in which we operate in. <br /></p>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="mt-16 mb-16">
			<div class="banner banner--white">
				<div class="container xl:max-w-screen-xl">
					...
					<div class="block items-center flex-col mx-auto mb-8 md:flex-row lg:max-w-screen-lg">
						<div class="typo">
							<h3><strong><?php echo $name; ?> Group: statement of GDPR compliance</strong></h3>
							<p>As part of our preparations for GDPR, an internal cross-functional team (the GDPR
								Steering Committee) was set up to lead <?php echo $name; ?>’ approach to GDPR. The GDPR
								Steering Committee will assume the responsibilities of the Data Protection Officer,
								actively monitoring the implementation of our policies and procedures relating to GDPR
								and providing an advisory service, thereby ensuring we remain compliant. </p>
							<p><strong>WHEN PROCESSING PERSONAL DATA, <?php echo $name; ?> GROUP HAS ADOPTED THE
									FOLLOWING PRINCIPLES, AS LAID DOWN IN THE EU GDPR REGULATION:</strong></p>
							<ol>
								<li>Personal Data shall be processed lawfully, fairly and in a transparent way. </li>
								<li>Personal Data shall be collected for specified, explicit and legitimate purposes
									only. </li>
								<li>Personal Data shall be adequate, relevant and limited to what is necessary in
									relation to the purposes for which they are processed. </li>
								<li>Personal Data shall be accurate and, kept up to date. This means
									<?php echo $name; ?> must have in place processes for identifying and addressing
									out-of-date, incorrect and redundant Personal Data. </li>
								<li>Personal Data shall be kept in a form which permits identification of Data Subjects
									for no longer than is necessary for the purposes for which the Personal Data is
									processed. </li>
								<li>The integrity and confidentiality of Personal Data is maintained at all times
									through appropriate technical and organisational measures, including protection
									against unauthorised or unlawful Processing, and against accidental loss,
									destruction or damage.</li>
							</ol>
							<p><strong>DATA SUBJECT RIGHTS</strong><br />GDPR is intended to give individuals, such as
								our employees, more power over how organisations like us manage their Personal Data.
								In-line with the GDPR we have reviewed and enhanced our procedures to enable such data
								to be located and anonymised or erased, in order to respond to requests to delete,
								rectify, transfer, access or restrict the Processing of Data. This will enable us to
								facilitate the below enhanced rights:</p>
							<ul>
								<li>Handling Data Subject Access Requests</li>
								<li>Handling data portability and rectification requests</li>
								<li>The application of retention periods and the secure erasure of personal data.</li>
							</ul>
							<p>In the unlikely event that a data breach should occur, we will implement a procedure for
								rectification, reporting to the Information Commissioner’s Office (ICO) and, where
								required, to the Data Subject in accordance with the regulation.</p>
							<p><strong>TRANSFER OF DATA</strong><br /><?php echo $name; ?> Group are an international
								employer with employees all over the world and offices in the UK, Europe, USA, Africa
								and MEICAP region and, as such, the Data we collect may be transferred to, and stored
								at, a destination outside the European Economic Area (‘EEA'). It may also be processed
								by staff operating outside the EEA who work for us or for one of our suppliers. Such
								staff may be engaged in, among other things, the fulfilment of your order, the
								processing of your payment details and the provision of support services. In line with
								the GDPR, <?php echo $name; ?> have the necessary safeguards in place to ensure data is
								safely and appropriately transferred.<br /></p>
							<p>Compliance will be supported by a review of existing contracts with data controllers and
								processors and any data export/sharing arrangements.<br /></p>
							<p>Our Privacy Policies and Data Protection Policy can be found on our Website and Intranet
								site (SIMS).</p>
